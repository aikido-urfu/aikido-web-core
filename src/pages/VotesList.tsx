      ...
      <List
        ...
        renderItem={(vote) => (
          <List.Item key={vote.id}>
            <Link
              to={`/vote?id=${vote.id}`}
              className={classes.voteLink}
              onMouseOver={(e) =>
                (e.currentTarget.className = classes.voteLinkHover)
              }
              onMouseOut={(e) =>
                (e.currentTarget.className = classes.voteLink)
              }
            >
              <List.Item.Meta title={vote.title} description={vote.description} />
            </Link>
          </List.Item>
        )}
      />
